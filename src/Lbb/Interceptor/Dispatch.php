...
class Dispatch
{
     ...
     */
    const CACHE_HEADER_FLAG = 'X-LbbEngine-Interceptor-Cache';
    ...
    /**
     * @var string 在 url 中加入时间戳，以阻挡网络传输中可能存在的缓存
     */
    protected $timestampQueryKey = '_eva_t';
    /**
